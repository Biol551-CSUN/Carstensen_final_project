---
title: "Biol551 Final Project - Pristionchus pacificus Ppa-hsd-2 constitutive dauer mutant and Ppa-odr-3 mutagenesis"
...
Click [here]() to view the code used to make this shiny app. 
...
my_color <- 'd3.scaleOrdinal() .domain(["Worms injected", "Successful","RFP+ F1s", "Heterozygous F1s", "Wild-type F1s", "Homozygous F2s", "Early stop", "Start codon deleted"]) .range(["#1D5C5D", "#5989C5" , "#A31000", "#69306D", "#8CC084", "#B85156", "EFD56B", "A7FFF6"])'  #Setting custom colors for each node
